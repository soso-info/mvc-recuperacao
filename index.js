      ...
      schemas: {
        ...
        UserRegistration: {
          ...
          properties: {
            ...
            papel: { type: "string", enum: ["participante", "organizador"] },
          },
        },
        Event: {
          allOf: [
...
pool
  ...
  .then((connection) => {
    connection.release();
    app.listen(port, () => console.log(`EventHub em http://localhost:${port}`));
  })
  .catch((error) => {
    console.error(
